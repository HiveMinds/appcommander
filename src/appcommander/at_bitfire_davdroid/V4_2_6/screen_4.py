...
def screen_4() -> Screen:
    ...
    required_objects: List[Dict[str, str]] = [
        ...
        },
        {
            ...
            "@text": (
                "Note: The issuer of this certificate may"
                + " inspect all traffic to and from the device."
            ),
        },
        {
            "@text": "OK",
...
def actions_0(dev: AutomatorDevice, screen: Screen, script: Script) -> Dict:
    ...
    # Fill the "Certificate name:" textbox with your own name of your CA cert.
    # dev(text="Certificate name").set_text(
